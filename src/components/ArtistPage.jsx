...
function AuthPage() {
  ...
  return (
    <div className="auth-page auth-page--split" ref={pageRef} onMouseMove={handlePageMove}>
      <AuthScene />

      <div className="auth-branding">
        <div className="auth-logo">
          <img src={vibrLogoDark} alt="VIBR" className="auth-logo-mark auth-logo-mark-dark" style={{ height: 90, width: "auto" }} />
          <img src={vibrLogoLight} alt="VIBR" className="auth-logo-mark auth-logo-mark-light" style={{ height: 90, width: "auto" }} />
        </div>
