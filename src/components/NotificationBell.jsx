...
function NotificationBell({ variant = "topbar" }) {
  ...
  return (
    <div className={variant === "sidebar" ? "notification-bell notification-bell--sidebar" : "notification-bell"} ref={ref}>
      ...
      >
        <svg className={variant === "sidebar" ? "nav-icon" : undefined} width={variant === "sidebar" ? undefined : "20"} height={variant === "sidebar" ? undefined : "20"} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
